...
%        flagPlotRinse  = any(~isnan(BpodSystem.Data.RawEvents.Trial{1,T}.States.OpenValveRinse));
        ...
        rasterLickPlot(BpodSystem.GUIHandles.rasterLickPlot, 'update',currentTrial(1,2), BpodSystem.Data.RawEvents.Trial{1, currentTrial(1,2)}.Events.Port2In,BpodSystem.Data.RawEvents.Trial{1, currentTrial(1,2)}.States.controlstate(1,1))
        end
