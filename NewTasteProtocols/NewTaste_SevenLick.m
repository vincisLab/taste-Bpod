...
%S.W.loadWaveform(2, Sound1);
%S.W.loadWaveform(2, S.white.white(2000:end));
...
sma = AddState(sma, 'Name', 'WaitForLick1_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick1_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick1_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick2_IN'},...
       'OutputActions', {'BNCState', 1});
   
sma = AddState(sma, 'Name', 'WaitForLick2_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick2_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick2_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick3_IN'},...
       'OutputActions', {'BNCState', 1});
   
sma = AddState(sma, 'Name', 'WaitForLick3_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick3_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick3_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick4_IN'},...
       'OutputActions', {'BNCState', 1});
   
   sma = AddState(sma, 'Name', 'WaitForLick4_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick4_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick4_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick5_IN'},...
       'OutputActions', {'BNCState', 1});
   
sma = AddState(sma, 'Name', 'WaitForLick5_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick5_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick5_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick6_IN'},...
       'OutputActions', {'BNCState', 1});
   
sma = AddState(sma, 'Name', 'WaitForLick6_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick6_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick6_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'WaitForLick7_IN'},...
       'OutputActions', {'BNCState', 1});
   
sma = AddState(sma, 'Name', 'WaitForLick7_IN', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick7_OUT','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
    
sma = AddState(sma, 'Name', 'WaitForLick7_OUT', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'OpenValve'},...
       'OutputActions', {'BNCState', 1});
% control state
...
sma = AddState(sma, 'Name', 'WaitForLick1_IN_rinse', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port2In', 'WaitForLick1_OUT_rinse','Tup','ZaberB1_rinse'},...
        'OutputActions', {}); 
%     
sma = AddState(sma, 'Name', 'WaitForLick1_OUT_rinse', ...
       'Timer', 0,...
       'StateChangeConditions', {'Port2Out', 'OpenValveRinse'},...
       'OutputActions', {'BNCState', 1});
...
%        flagPlotRinse  = any(~isnan(BpodSystem.Data.RawEvents.Trial{1,T}.States.OpenValveRinse));
        ...
        rasterLickPlot(BpodSystem.GUIHandles.rasterLickPlot, 'update',currentTrial(1,2), BpodSystem.Data.RawEvents.Trial{1, currentTrial(1,2)}.Events.Port2Out,BpodSystem.Data.RawEvents.Trial{1, currentTrial(1,2)}.States.controlstate(1,1))
        end
