function olfacto_close(vial)

% vial is going to be an integer
...
%Set MFC example
% set_flowrate(s, MFC number, desired flow, capacity)
% set_flowrate(s, 1, 300, 1000);
% set_flowrate(s, 2, 70, 200);
%
% pause(5);
%
% %Poll MFC example
