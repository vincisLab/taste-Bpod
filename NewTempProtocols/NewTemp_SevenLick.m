...
%% Licking shit
    ...
    S.A.ResetVoltages(1)  = 3                 ;                  % Reset for lick detection %
...
%     S = BpodParameterGUI('sync', S)                                       ;                            % Sync parameters with BpodParameterGUI plugin
    ...
    switch currentTrial(1,1)
        ...
        case 8 % spout in the rig: number 4 % Changes made by Roberto --- change it back if multiple spouts will be used or if line 8 is not used
...
sma = AddState(sma, 'Name', 'LateralMotor', ...   % move the lateral motor to put in position the correct spout
    ...
    'OutputActions', {}); % 031822 - remove {'SoftCode',5 } from 'OutputAction'
...
%     'OutputActions', {'ValveModule1',  3, 'BNCState', 1}); % Sends serial message 1, opening the valve.
